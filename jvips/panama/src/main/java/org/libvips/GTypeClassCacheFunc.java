...
public interface GTypeClassCacheFunc {
    ...
    static MemorySegment allocate(GTypeClassCacheFunc fi, MemorySession session) {
        return RuntimeHelper.upcallStub(GTypeClassCacheFunc.class, fi, constants$10.GTypeClassCacheFunc$FUNC, session);
    }
    static GTypeClassCacheFunc ofAddress(MemoryAddress addr, MemorySession session) {
        ...
        return (java.lang.foreign.MemoryAddress _cache_data, java.lang.foreign.MemoryAddress _g_class) -> {
            try {
                return (int)constants$10.GTypeClassCacheFunc$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)_cache_data, (java.lang.foreign.Addressable)_g_class);
            } catch (Throwable ex$) {
