...
class constants$0 {
    ...
    static final MethodHandle g_clear_pointer$MH = RuntimeHelper.downcallHandle(
        "g_clear_pointer",
        constants$0.g_clear_pointer$FUNC
    );
