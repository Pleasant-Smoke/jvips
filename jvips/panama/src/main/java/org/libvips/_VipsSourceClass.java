...
public class _VipsSourceClass {
    ...
    public static MemoryLayout $LAYOUT() {
        return _VipsSourceClass.$struct$LAYOUT;
    }
    ...
    public interface read {
        ...
        static MemorySegment allocate(read fi, MemorySession session) {
            return RuntimeHelper.upcallStub(read.class, fi, _VipsSourceClass.read$FUNC, session);
        }
        static read ofAddress(MemoryAddress addr, MemorySession session) {
            ...
            return (java.lang.foreign.MemoryAddress __x0, java.lang.foreign.MemoryAddress __x1, long __x2) -> {
                try {
                    return (long)_VipsSourceClass.read$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)__x0, (java.lang.foreign.Addressable)__x1, __x2);
                } catch (Throwable ex$) {
    ...
    public static VarHandle read$VH() {
        return _VipsSourceClass.read$VH;
    }
    public static MemoryAddress read$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_VipsSourceClass.read$VH.get(seg);
    }
    public static void read$set( MemorySegment seg, MemoryAddress x) {
        _VipsSourceClass.read$VH.set(seg, x);
    }
    public static MemoryAddress read$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_VipsSourceClass.read$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void read$set(MemorySegment seg, long index, MemoryAddress x) {
        _VipsSourceClass.read$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public interface seek {
        ...
        static MemorySegment allocate(seek fi, MemorySession session) {
            return RuntimeHelper.upcallStub(seek.class, fi, _VipsSourceClass.seek$FUNC, session);
        }
        static seek ofAddress(MemoryAddress addr, MemorySession session) {
            ...
            return (java.lang.foreign.MemoryAddress __x0, long __x1, int __x2) -> {
                try {
                    return (long)_VipsSourceClass.seek$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)__x0, __x1, __x2);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static VarHandle seek$VH() {
        return _VipsSourceClass.seek$VH;
    }
    public static MemoryAddress seek$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_VipsSourceClass.seek$VH.get(seg);
    }
    public static void seek$set( MemorySegment seg, MemoryAddress x) {
        _VipsSourceClass.seek$VH.set(seg, x);
    }
    public static MemoryAddress seek$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_VipsSourceClass.seek$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void seek$set(MemorySegment seg, long index, MemoryAddress x) {
        _VipsSourceClass.seek$VH.set(seg.asSlice(index*sizeof()), x);
    }
