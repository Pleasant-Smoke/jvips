...
public class im__INTMASK {
    ...
    ).withName("im__INTMASK");
    public static MemoryLayout $LAYOUT() {
        return im__INTMASK.$struct$LAYOUT;
    }
    ...
    public static VarHandle scale$VH() {
        return im__INTMASK.scale$VH;
    }
    public static int scale$get(MemorySegment seg) {
        return (int)im__INTMASK.scale$VH.get(seg);
    }
    public static void scale$set( MemorySegment seg, int x) {
        im__INTMASK.scale$VH.set(seg, x);
    }
    public static int scale$get(MemorySegment seg, long index) {
        return (int)im__INTMASK.scale$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void scale$set(MemorySegment seg, long index, int x) {
        im__INTMASK.scale$VH.set(seg.asSlice(index*sizeof()), x);
    }
    static final VarHandle offset$VH = $struct$LAYOUT.varHandle(MemoryLayout.PathElement.groupElement("offset"));
    public static VarHandle offset$VH() {
        return im__INTMASK.offset$VH;
    }
    public static int offset$get(MemorySegment seg) {
        return (int)im__INTMASK.offset$VH.get(seg);
    }
    public static void offset$set( MemorySegment seg, int x) {
        im__INTMASK.offset$VH.set(seg, x);
    }
    public static int offset$get(MemorySegment seg, long index) {
        return (int)im__INTMASK.offset$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void offset$set(MemorySegment seg, long index, int x) {
        im__INTMASK.offset$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle coeff$VH() {
        return im__INTMASK.coeff$VH;
    }
    public static MemoryAddress coeff$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)im__INTMASK.coeff$VH.get(seg);
    }
    public static void coeff$set( MemorySegment seg, MemoryAddress x) {
        im__INTMASK.coeff$VH.set(seg, x);
    }
    public static MemoryAddress coeff$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)im__INTMASK.coeff$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void coeff$set(MemorySegment seg, long index, MemoryAddress x) {
        im__INTMASK.coeff$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    public static VarHandle filename$VH() {
        return im__INTMASK.filename$VH;
    }
    public static MemoryAddress filename$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)im__INTMASK.filename$VH.get(seg);
    }
    public static void filename$set( MemorySegment seg, MemoryAddress x) {
        im__INTMASK.filename$VH.set(seg, x);
    }
    public static MemoryAddress filename$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)im__INTMASK.filename$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void filename$set(MemorySegment seg, long index, MemoryAddress x) {
        im__INTMASK.filename$VH.set(seg.asSlice(index*sizeof()), x);
    }
