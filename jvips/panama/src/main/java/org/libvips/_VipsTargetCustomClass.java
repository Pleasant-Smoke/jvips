...
public class _VipsTargetCustomClass {
    ...
    static final  GroupLayout $struct$LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.structLayout(
            ...
            Constants$root.C_POINTER$LAYOUT.withName("finish"),
    ...
    public static MemoryLayout $LAYOUT() {
        return _VipsTargetCustomClass.$struct$LAYOUT;
    }
    public static MemorySegment parent_class$slice(MemorySegment seg) {
        return seg.asSlice(0, 368);
    }
    ...
    static final MethodHandle write$MH = RuntimeHelper.downcallHandle(
        _VipsTargetCustomClass.write$FUNC
    );
    public interface write {
        ...
        static MemorySegment allocate(write fi, MemorySession session) {
            return RuntimeHelper.upcallStub(write.class, fi, _VipsTargetCustomClass.write$FUNC, session);
        }
        static write ofAddress(MemoryAddress addr, MemorySession session) {
            ...
            return (java.lang.foreign.MemoryAddress __x0, java.lang.foreign.MemoryAddress __x1, long __x2) -> {
                try {
                    return (long)_VipsTargetCustomClass.write$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)__x0, (java.lang.foreign.Addressable)__x1, __x2);
                } catch (Throwable ex$) {
    ...
    public static VarHandle write$VH() {
        return _VipsTargetCustomClass.write$VH;
    }
    public static MemoryAddress write$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_VipsTargetCustomClass.write$VH.get(seg);
    }
    public static void write$set( MemorySegment seg, MemoryAddress x) {
        _VipsTargetCustomClass.write$VH.set(seg, x);
    }
    public static MemoryAddress write$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_VipsTargetCustomClass.write$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void write$set(MemorySegment seg, long index, MemoryAddress x) {
        _VipsTargetCustomClass.write$VH.set(seg.asSlice(index*sizeof()), x);
    }
    public static write write (MemorySegment segment, MemorySession session) {
        return write.ofAddress(write$get(segment), session);
    }
    static final FunctionDescriptor finish$FUNC = FunctionDescriptor.ofVoid(
        Constants$root.C_POINTER$LAYOUT
    );
    static final MethodHandle finish$MH = RuntimeHelper.downcallHandle(
        _VipsTargetCustomClass.finish$FUNC
    );
    public interface finish {

        void apply(java.lang.foreign.MemoryAddress _x0);
        static MemorySegment allocate(finish fi, MemorySession session) {
            return RuntimeHelper.upcallStub(finish.class, fi, _VipsTargetCustomClass.finish$FUNC, session);
        }
        static finish ofAddress(MemoryAddress addr, MemorySession session) {
            MemorySegment symbol = MemorySegment.ofAddress(addr, 0, session);
            return (java.lang.foreign.MemoryAddress __x0) -> {
                try {
                    _VipsTargetCustomClass.finish$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)__x0);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    static final VarHandle finish$VH = $struct$LAYOUT.varHandle(MemoryLayout.PathElement.groupElement("finish"));
    public static VarHandle finish$VH() {
        return _VipsTargetCustomClass.finish$VH;
    }
    public static MemoryAddress finish$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_VipsTargetCustomClass.finish$VH.get(seg);
    }
    public static void finish$set( MemorySegment seg, MemoryAddress x) {
        _VipsTargetCustomClass.finish$VH.set(seg, x);
    }
    public static MemoryAddress finish$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_VipsTargetCustomClass.finish$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void finish$set(MemorySegment seg, long index, MemoryAddress x) {
        _VipsTargetCustomClass.finish$VH.set(seg.asSlice(index*sizeof()), x);
    }
    public static finish finish (MemorySegment segment, MemorySession session) {
        return finish.ofAddress(finish$get(segment), session);
    }
    ...
    static final MethodHandle read$MH = RuntimeHelper.downcallHandle(
        _VipsTargetCustomClass.read$FUNC
    );
    public interface read {

        long apply(java.lang.foreign.MemoryAddress _x0, java.lang.foreign.MemoryAddress _x1, long _x2);
        static MemorySegment allocate(read fi, MemorySession session) {
            return RuntimeHelper.upcallStub(read.class, fi, _VipsTargetCustomClass.read$FUNC, session);
        }
        static read ofAddress(MemoryAddress addr, MemorySession session) {
            MemorySegment symbol = MemorySegment.ofAddress(addr, 0, session);
            return (java.lang.foreign.MemoryAddress __x0, java.lang.foreign.MemoryAddress __x1, long __x2) -> {
                try {
                    return (long)_VipsTargetCustomClass.read$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)__x0, (java.lang.foreign.Addressable)__x1, __x2);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static VarHandle read$VH() {
        return _VipsTargetCustomClass.read$VH;
    }
    public static MemoryAddress read$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_VipsTargetCustomClass.read$VH.get(seg);
    }
    public static void read$set( MemorySegment seg, MemoryAddress x) {
        _VipsTargetCustomClass.read$VH.set(seg, x);
    }
    public static MemoryAddress read$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_VipsTargetCustomClass.read$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void read$set(MemorySegment seg, long index, MemoryAddress x) {
        _VipsTargetCustomClass.read$VH.set(seg.asSlice(index*sizeof()), x);
    }
    ...
    static final MethodHandle seek$MH = RuntimeHelper.downcallHandle(
        _VipsTargetCustomClass.seek$FUNC
    );
    public interface seek {
        ...
        static MemorySegment allocate(seek fi, MemorySession session) {
            return RuntimeHelper.upcallStub(seek.class, fi, _VipsTargetCustomClass.seek$FUNC, session);
        }
        static seek ofAddress(MemoryAddress addr, MemorySession session) {
            ...
            return (java.lang.foreign.MemoryAddress __x0, long __x1, int __x2) -> {
                try {
                    return (long)_VipsTargetCustomClass.seek$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)__x0, __x1, __x2);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static VarHandle seek$VH() {
        return _VipsTargetCustomClass.seek$VH;
    }
    public static MemoryAddress seek$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_VipsTargetCustomClass.seek$VH.get(seg);
    }
    public static void seek$set( MemorySegment seg, MemoryAddress x) {
        _VipsTargetCustomClass.seek$VH.set(seg, x);
    }
    public static MemoryAddress seek$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_VipsTargetCustomClass.seek$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void seek$set(MemorySegment seg, long index, MemoryAddress x) {
        _VipsTargetCustomClass.seek$VH.set(seg.asSlice(index*sizeof()), x);
    }
    public static seek seek (MemorySegment segment, MemorySession session) {
        return seek.ofAddress(seek$get(segment), session);
    }
    static final FunctionDescriptor end$FUNC = FunctionDescriptor.of(Constants$root.C_INT$LAYOUT,
        Constants$root.C_POINTER$LAYOUT
    );
    static final MethodHandle end$MH = RuntimeHelper.downcallHandle(
        _VipsTargetCustomClass.end$FUNC
    );
    public interface end {

        int apply(java.lang.foreign.MemoryAddress _x0);
        static MemorySegment allocate(end fi, MemorySession session) {
            return RuntimeHelper.upcallStub(end.class, fi, _VipsTargetCustomClass.end$FUNC, session);
        }
        static end ofAddress(MemoryAddress addr, MemorySession session) {
            MemorySegment symbol = MemorySegment.ofAddress(addr, 0, session);
            return (java.lang.foreign.MemoryAddress __x0) -> {
                try {
                    return (int)_VipsTargetCustomClass.end$MH.invokeExact((Addressable)symbol, (java.lang.foreign.Addressable)__x0);
                } catch (Throwable ex$) {
                    throw new AssertionError("should not reach here", ex$);
                }
            };
    ...
    public static VarHandle end$VH() {
        return _VipsTargetCustomClass.end$VH;
    }
    public static MemoryAddress end$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_VipsTargetCustomClass.end$VH.get(seg);
    }
    public static void end$set( MemorySegment seg, MemoryAddress x) {
        _VipsTargetCustomClass.end$VH.set(seg, x);
    }
    public static MemoryAddress end$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_VipsTargetCustomClass.end$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void end$set(MemorySegment seg, long index, MemoryAddress x) {
        _VipsTargetCustomClass.end$VH.set(seg.asSlice(index*sizeof()), x);
    }
