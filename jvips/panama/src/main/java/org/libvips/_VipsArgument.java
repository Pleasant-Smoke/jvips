...
public class _VipsArgument {
    ...
    public static MemoryLayout $LAYOUT() {
        return _VipsArgument.$struct$LAYOUT;
    }
    ...
    public static VarHandle pspec$VH() {
        return _VipsArgument.pspec$VH;
    }
    public static MemoryAddress pspec$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_VipsArgument.pspec$VH.get(seg);
    }
    public static void pspec$set( MemorySegment seg, MemoryAddress x) {
        _VipsArgument.pspec$VH.set(seg, x);
    }
    public static MemoryAddress pspec$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_VipsArgument.pspec$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void pspec$set(MemorySegment seg, long index, MemoryAddress x) {
        _VipsArgument.pspec$VH.set(seg.asSlice(index*sizeof()), x);
    }
