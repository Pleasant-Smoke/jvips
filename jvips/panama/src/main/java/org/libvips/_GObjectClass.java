...
public class _GObjectClass {
    ...
    public static MemoryAddress pspecs$get(MemorySegment seg) {
        return (java.lang.foreign.MemoryAddress)_GObjectClass.pspecs$VH.get(seg);
    }
    public static void pspecs$set( MemorySegment seg, MemoryAddress x) {
        _GObjectClass.pspecs$VH.set(seg, x);
    }
    public static MemoryAddress pspecs$get(MemorySegment seg, long index) {
        return (java.lang.foreign.MemoryAddress)_GObjectClass.pspecs$VH.get(seg.asSlice(index*sizeof()));
    }
    public static void pspecs$set(MemorySegment seg, long index, MemoryAddress x) {
