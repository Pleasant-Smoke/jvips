...
public class VipsException extends Exception {
    ...
    public VipsException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
        super(message, cause, enableSuppression, writableStackTrace);
    }

    public static VipsException create(String message, Object... args){
        return new VipsException(String.format(message, args));
    }
}
