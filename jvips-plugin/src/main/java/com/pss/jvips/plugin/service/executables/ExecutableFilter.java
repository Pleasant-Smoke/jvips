...
public interface ExecutableFilter extends VersionedService {
    List<AbstractExecutable> filterExecutablesHistorical(Namespace namespace, List<String> whitelist);
}
