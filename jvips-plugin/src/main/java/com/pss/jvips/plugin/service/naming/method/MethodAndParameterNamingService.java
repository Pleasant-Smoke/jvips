...
public interface MethodAndParameterNamingService extends VersionedService {


    History<TokenizedJavaCaseFormat> getTokenizedMethodName(String name);

    History<JavaCaseFormat> getParameterName(String name);

    Optional<History<TokenizedJavaCaseFormat>> findMethod(String name);

    Optional<History<JavaCaseFormat>> findParameter(String name);
}
