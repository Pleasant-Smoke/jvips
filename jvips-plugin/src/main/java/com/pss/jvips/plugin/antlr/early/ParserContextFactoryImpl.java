...
public class ParserContextFactoryImpl {

    protected final Path srcDir;
    protected final History<Version> version;

    public ParserContextFactoryImpl(Path srcDir, History<Version> version) {
        this.srcDir = srcDir;
        this.version = version;
    }

//    public ParserContext createContext(){
//        return ImmutableParserContext.builder().
//    }
