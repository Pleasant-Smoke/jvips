...
public class MethodNameTokenizerDelegate extends VersionedDelegate<MethodNameTokenizer> {

    public MethodNameTokenizerDelegate(History<Version> context, SortedSet<MethodNameTokenizer> services) {
