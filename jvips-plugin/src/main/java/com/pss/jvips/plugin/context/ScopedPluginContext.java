...
public record ScopedPluginContext(GlobalPluginContext globalContext,
                                  AbstractExecutable currentExecutable, ClassName currentClass) {
    public OperationContext operationContext() {
        return globalContext.operationContext();
    }
