...
public final class ClassNameTest {
   ...
   */
  @Ignore("Need to fix this probably with power mock")
  ...
  private TypeElement preventGetKind(TypeElement object) {
    ...
    when(spy.getKind()).thenThrow(new AssertionError()); // This is throwing a null pointer exception, Cannot invoke "com.sun.tools.javac.code.Symbol$Completer.complete(com.sun.tools.javac.code.Symbol)" because "c" is null
